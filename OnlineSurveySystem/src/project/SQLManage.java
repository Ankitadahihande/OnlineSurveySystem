...
public class SQLManage {
	...
	public SQLManage() throws SQLException {
		String url = "jdbc:mysql://127.0.0.1:3307/survey?useSSL=false\",\"root\",\"3307\"";
				
				String usr;
				Connection con=DriverManager.getConnection("jdbc:mysql://127.0.0.1:3307/survey?useSSL=false","root","3307");
	}
